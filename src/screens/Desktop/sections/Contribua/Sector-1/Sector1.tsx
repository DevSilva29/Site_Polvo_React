      ...
      <Card className="max-w-[879px] mx-auto bg-[#ffffffb2] rounded-[10px]">
        <CardContent className="p-16">
          <div className="space-y-8">
            ...
            {/* Bloco tipo tabela em 3 colunas */}
            <div className="mt-6">
              <h2 className="text-center text-2xl font-bold text-black">
                PARA DOAÇÕES
              </h2>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 border border-gray-300 mt-6 p-4">
                {/* Depósito / Transferência */}
                <div className="text-center border-r md:border-r border-gray-300 pr-4 flex flex-col items-center justify-center">
                  <p className="text-lg font-bold">DEPÓSITO<br />OU<br />TRANSFERÊNCIA</p>
                  <p className="text-base mt-4">BANCO: ITAÚ</p>
                  <p className="text-base">AGÊNCIA: 2931</p>
                  <p className="text-base">CONTA CORRENTE: 01699-8</p>
                </div>

                {/* Em dinheiro */}
                <div className="text-center border-r md:border-r border-gray-300 px-4 flex flex-col items-center justify-center">
                  <p className="text-lg font-bold">EM DINHEIRO</p>
                  <p className="text-base mt-4">PROCURAR<br />TESOURARIA</p>
                </div>
                ...
                <div className="text-center px-4 flex flex-col items-center justify-center">
                  ...
                  {/* Certifique-se que /frame-1.png existe na public/ */}
                  <img
                  ...
                  <p className="text-sm text-black mt-2">* Escaneie com o aplicativo do seu banco</p>
                </div>
              </div>
            </div>
          </div>
